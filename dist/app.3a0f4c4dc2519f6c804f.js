...
let $resumeWrap = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__vQuery__["a" /* default */])('#app .resume-wrap'); // 选择index.tpl.html节点
let resumeWrap = $resumeWrap.get(0);
let $resumeTag = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__vQuery__["a" /* default */])('.resume-tag', resumeWrap);
let $resumeMarkdown = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__vQuery__["a" /* default */])('.resume-markdown', resumeWrap);
...
let $stylesWrap = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__vQuery__["a" /* default */])('#app .styles-wrap');
let stylesWrap = $stylesWrap.get(0);
let $style = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__vQuery__["a" /* default */])('style', stylesWrap);
let $stylePre = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__vQuery__["a" /* default */])('pre', stylesWrap);
...
showStylesWrap(0).then(showResumeWrap).then(showStylesWrap.bind(null, 1)).then(markdownToHtmlWrap).then(showStylesWrap.bind(null, 2)).catch(err => {
    console.log(err);
});
...
"use strict";
let resumeMarkdown = `Jesonhu
----

一只迷途的前端小码农，徜徉在计算机的世界，希望能够以热爱的兴趣前端为职业
...
* [GitHub](https://github.com/jesonhu)

> 如果你喜欢这个效果，Fork [我的项目](https://github.com/jesonhu/resume-move)，打造你自己的简历！
