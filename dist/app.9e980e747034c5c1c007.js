...
let $stylesWrap = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__vQuery__["a" /* default */])('#app .style-wrap');
...
console.log($stylesWrap, $stylesWrap.height());
...
const showStyles = (num, callback) => {
    ...
    timer = setInterval(() => {
        ...
        if (currentStyle.length === length) {
            ...
            console.log($stylePre.height(), MAX_HEIGHT, top);
            if (top > 0) {
                goBottom(top);
            }
